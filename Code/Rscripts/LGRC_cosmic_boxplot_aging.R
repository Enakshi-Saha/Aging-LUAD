...
maintitle = "Cosmic Gene Targeting: t-statistic (age coefficient in LGRC)"
...
tb_smoker <- read.csv("~/Recount3_GTEx_TCGA_Data/TPM_expression/newdata2023_aging/limma_GSEA_aging/limma_LGRC_smoker_aging.txt", sep="")
tb_nonsmoker <- read.csv("~/Recount3_GTEx_TCGA_Data/TPM_expression/newdata2023_aging/limma_GSEA_aging/limma_LGRC_nonsmoker_aging.txt", sep="")

tb_smoker$gene_name = rownames(tb_smoker)
tb_nonsmoker$gene_name = rownames(tb_nonsmoker)

maintitle = "Oncogene Targeting in LGRC: t-statistic (by smoking status)"
...
maintitle = "TSG Targeting in LGRC: t-statistic (by smoking status)"
...
maintitle = "Non-cancer gene Targeting in LGRC: t-statistic (by smoking status)"
